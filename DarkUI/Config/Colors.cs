...
namespace DarkUI.Config
{
    public sealed class Colors
    {
        ...
        {
            get { return Color.FromArgb(95, 66, 66); }
        }

        public static Color DarkBlueBackground
        {
            get { return Color.FromArgb(67, 53, 53); }
        }
        ...
        {
            get { return Color.FromArgb(186, 105, 105); }
        }

        public static Color BlueSelection
        {
            get { return Color.FromArgb(176, 75, 75); }
        }
        ...
        {
            get { return Color.FromArgb(80, 52, 53); }
        }

        public static Color LightBlueBorder
        {
            get { return Color.FromArgb(115, 86, 86); }
        }

        public static Color ActiveControl
        {
            get { return Color.FromArgb(196, 130, 130); }
        }
